...
///* From Viewcontroller
//
////       Test des inits de paquets
////        let paquet1 = PaquetDeCarte.init()
////        print("Paquet1 =\(paquet1)")
////        if let paquet2 = PaquetDeCarte.init(nombreDeValeursDeCartes:-3)
////        {print("Paquet2 =\(paquet2)")}
////        if let paquet3 = PaquetDeCarte.init(nombreDeValeursDeCartes:60)
////        {print("Paquet3 =\(paquet3)")}
//
//// Having fun with layer of a view....
...
//*/
//
///* From CardView (syntax to draw)
// // Syntaxe en edrivant directement dans e contexte
